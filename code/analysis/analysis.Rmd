...
- why are some point estimates missing from plots?
...
The "training" data set which we used to refine the code with was `r percent_split`% of the full dataset. Results are reported from the remaining `r reverse_percent_split`% testing data set.
...
# p_nonzero <-
#   data_diff_zero_combined %>%
#   ggplot(aes(fct_rev(measure), estimate, color = domain, shape = domain)) +
...
#   mdthemes::md_theme_linedraw() +
#   labs(x = "",
#        y = "Proportion of participants<br/>with non-zero effects",
#        color = "Domain",
#        shape = "Domain") +
#   theme(legend.position = "top",
