...
if(file.exists("../../data/results/data_discriminability_preregistered.csv")) {

  data_discriminability <- read_csv("../../data/results/data_discriminability_preregistered.csv") |>
  ...
  # save to disk
  write_csv(data_discriminability, "../../data/results/data_discriminability_preregistered.csv")
...
ggsave(filename  = "plots/figure_1_cis_by_domain_logit.pdf",
...
ggsave(filename  = "plots/figure_2_metaanalyses_logit.pdf",
       plot      = p_combined,
       device    = "pdf",
       # path      = NULL,
       # dpi       = 300,
