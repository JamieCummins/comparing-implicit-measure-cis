...
write_rds(all_exclusions_applied_df, "../../data/processed/data_trials_for_bootstrapping.rds")
...
if(TRUE){
  ...
  if(subset_sample == TRUE) {
    ...
    trials_to_process <- all_exclusions_applied_df |>
      filter(measure == "ept") # delete dis after
  }
...
# update_old <- read_rds("../../data/processed/data_processed.rds") |>
#   filter(measure != "ept") |>
#   bind_rows(A_scores)
# 
# write_rds(update_old, "../../data/processed/data_processed.rds")
