...
raw_trial_level_df <- read.delim("raw/impraw.txt") 
raw_sessions_df <- read.delim("raw/allds.txt")
...
if(FALSE) {
  ...
  pi_scores <- read_rds("models/pi_scores.rds")
  ...
  # save to disk
  write_rds(pi_scores, "models/pi_scores.rds")
